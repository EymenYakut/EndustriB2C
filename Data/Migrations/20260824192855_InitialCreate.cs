    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFeaturesHeaders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductFeaturesHeaderId = table.Column<int>(type: "int", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFeaturesDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductFeaturesDetails_ProductFeaturesHeaders_ProductFeaturesHeaderId",
                        column: x => x.ProductFeaturesHeaderId,
                        principalTable: "ProductFeaturesHeaders",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPrices_Campaigns_CampaignId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFullName = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    ...
                    ShippingDistrict = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ShippingAddressLine = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ShippingPostalCode = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHeaders_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_CampaignId",
                table: "OrderHeaders",
                column: "CampaignId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFeaturesDetails_ProductFeaturesHeaderId",
                table: "ProductFeaturesDetails",
                column: "ProductFeaturesHeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFeaturesDetails_ProductId_ProductFeaturesHeaderId",
                table: "ProductFeaturesDetails",
                columns: new[] { "ProductId", "ProductFeaturesHeaderId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPrices_CampaignId",
                table: "ProductPrices",
                column: "CampaignId");
